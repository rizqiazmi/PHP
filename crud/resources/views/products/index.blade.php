                ...
                @if (count($products) > 0)
                    @foreach ($products as $product)
                        ...
                        <div style="display: flex">     
                            ...
                            <button class="btn btn-success" style="padding-top: 4px; padding-bottom:4px">
                            ...
                            <form method="post" action="{{ route('products.destroy', $product->id) }}">
                                @method('delete')
                                @csrf
                                    <button class="btn btn-danger" style="padding-top: 4px; padding-bottom:4px" onclick="deleteConfirm(event)">
